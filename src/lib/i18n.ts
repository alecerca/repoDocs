...
const DICT: Record<string, { en: string; es: string }> = {
  ...
  'toast.pngDownloaded': { en: 'Canvas PNG downloaded', es: 'Canvas PNG descargado' },
  'toast.imageCopied': { en: 'Canvas image copied to clipboard', es: 'Imagen del canvas copiada al portapapeles' },
  'toast.shareCopied': { en: 'Shareable layout link copied to clipboard', es: 'Enlace del layout copiado al portapapeles' },
  'toast.sharedLayoutLoaded': { en: 'Shared canvas layout loaded', es: 'Layout de canvas compartido cargado' },
  'toast.exportFailed': { en: 'Could not export canvas image', es: 'No se pudo exportar la imagen del canvas' },
  // sidebar
  'sidebar.foot.hint': {
  ...
  'canvas.exportPng': { en: 'PNG', es: 'PNG' },
  'canvas.exportPng.title': { en: 'Export canvas composition as PNG', es: 'Exportar composición del canvas a PNG' },
  'canvas.share': { en: 'Share', es: 'Compartir' },
  'canvas.share.title': { en: 'Share layout link', es: 'Compartir enlace del layout' },
  'canvas.export.modalTitle': { en: 'Export Canvas', es: 'Exportar Canvas' },
  'canvas.export.framing': { en: 'Framing', es: 'Encuadre' },
  'canvas.export.composition': { en: 'Full composition', es: 'Composición completa' },
  'canvas.export.viewport': { en: 'Current viewport', es: 'Vista actual' },
  'canvas.export.resolution': { en: 'Resolution', es: 'Resolución' },
  'canvas.export.scale1x': { en: '1x (Standard)', es: '1x (Estándar)' },
  'canvas.export.scale2x': { en: '2x (Retina HD)', es: '2x (Retina HD)' },
  'canvas.export.background': { en: 'Background', es: 'Fondo' },
  'canvas.export.bgCanvas': { en: 'Canvas dot grid', es: 'Canvas con cuadrícula de puntos' },
  'canvas.export.bgSolid': { en: 'Solid background', es: 'Fondo sólido' },
  'canvas.export.bgTransparent': { en: 'Transparent', es: 'Transparente' },
  'canvas.export.header': { en: 'Include title badge', es: 'Incluir badge de título' },
  'canvas.export.download': { en: 'Download PNG', es: 'Descargar PNG' },
  'canvas.export.copy': { en: 'Copy Image', es: 'Copiar imagen' },
  'canvas.export.generating': { en: 'Exporting...', es: 'Exportando...' },
  'canvas.share.modalTitle': { en: 'Share Canvas Layout', es: 'Compartir layout del canvas' },
  'canvas.share.desc': {
    en: 'Anyone with this link will open this exact card arrangement.',
    es: 'Cualquiera con este enlace abrirá esta composición exacta de tarjetas.',
  },
  'canvas.share.includeCamera': {
    en: 'Include camera zoom and position',
    es: 'Incluir zoom y posición de cámara',
  },
  'canvas.share.copy': { en: 'Copy Link', es: 'Copiar enlace' },
  'canvas.share.copied': { en: 'Copied!', es: '¡Copiado!' },
  // inspector
